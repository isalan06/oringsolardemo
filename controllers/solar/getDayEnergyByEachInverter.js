...
const getDayEnergyByEachInverter=(group, inverters, searchdate, func)=>{
    var inv_number = inverters.length;

    var commandString = 'SELECT ';
    commandString += 'inverter_id, r_day, SUM(energy) AS totalenergy ';
    commandString += 'FROM (';
        commandString += 'SELECT ';
        commandString += 'r_day, inverter_id, (energy_end - energy_start) AS energy ';
    ...
    commandString += 'GROUP BY inverter_id, r_day;';
...
module.exports=getDayEnergyByEachInverter;